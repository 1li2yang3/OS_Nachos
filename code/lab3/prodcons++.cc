...
printf("4\n");
    ...
    // ....
    nempty = new Semaphore("nempty", BUFF_SIZE);//初始化
...
printf("6\n");
    ...
    for (i=0; i < N_PROD; i++) 
    {
      ...
      //  ...
      producers[i] = new Thread(prod_names[i]);//建立生产者
...
printf("7\n");
    ...
    for (i=0; i < N_CONS; i++) 
    {
      ...
      //  ...
      consumers[i] = new Thread(cons_names[i]);//建立消费者
